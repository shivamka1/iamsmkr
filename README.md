...
- [Tackling Heterogeneity in Apache Arrow Value Vectors Using Shapeless](http://localhost:80/2022/07/17/tackling-heterogeneity-in-apache-arrow-value-vectors-using-shapeless/)
- [Discovering Services using Apache Curator in Scala](http://localhost:80/2022/07/08/discovering-services-using-apache-curator-in-scala/)
- [Redpanda Highlights](http://localhost:80/2021/12/13/redpanda-insights/)
- [Ensure Conventional Commits in your SBT projects](http://localhost:80/2021/10/16/ensure-conventional-commits-in-your-sbt-projects/)
- [Making sense of Functors in Scala](http://localhost:80/2021/06/04/making-sense-of-functors-in-scala/)
<!-- BLOG-POST-LIST:END -->

## Connect With Me
[<img align="left" alt="stackoverflow" width="30px" height="30px" src="https://i.postimg.cc/L6mYn4nv/stack-overflow.png" />](https://stackoverflow.com/users/1879109/shivam-kapoor)
